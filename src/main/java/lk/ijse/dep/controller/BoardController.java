...
public class BoardController implements BoardUI {
    ...
    public Group getGrpCols() {
        return grpCols;
    }

    public void setGrpCols(Group grpCols) {
    ...
    public Pane getPneOver() {
        return pneOver;
    }

    public void setPneOver(Pane pneOver) {
        this.pneOver = pneOver;
    }

    public JFXButton getBtnPlayAgain() {
        return btnPlayAgain;
    }

    public void setBtnPlayAgain(JFXButton btnPlayAgain) {
